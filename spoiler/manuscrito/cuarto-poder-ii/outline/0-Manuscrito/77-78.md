...
notes:          
                ...
                Intentan escoltar a Lucas al edificio principal para que lo duerman, peo Lucas se escapa un momento para asegurarse de que Ana está a salvo y ve que se la han llevado.
                
                - **¿Hago que aquí le ataque la niña pequeña y se "despierta" ya dentro de la red?**
                ...
                Lucas y algunos van hasta el edificio principal donde ven que se han llevado a Ana.
                
                - ¿Lucas salva a Lara deteniendo a Jonás y "peleando" contra él hasta que lo convence de cederle el conocimiento de la señal? ¿O se lo arrebata y Jonás va a intentar matarlo? ¿Lo inyecta con el "antídoto" de RIO?
                ...
                - **¿Se desplazan a algún sitio o lo hacen desde la propia base de la *Resitencia*?**
                - ¿RIO vuelve violentos a los de la *Resistencia* y "controlan" a Lucas para que busque a Jonás y le extraiga la *Señal* mientras que la *Sirena* intenta convencerle de que está alucinando?
                
                A Lucas le inducen una especie de coma para que pueda mantenerse en el "vacío".
                ...
                Jonás se niega a acercarse a RIO, por lo que encuentran otra manera de hacer el volcado de su conocimiento en Lucas (¿voluntaria o involuntaria?).
                
                Lucas es clave para esto, ya que su nivel de asimilación y su conexión a la *Sirena* lo convierte en un *hub* desde el que emitir la señal al resto de la red ("credenciales biométricas" para acceder a la red que sólo tienen los *asimilados*). Además, Marta se aseguró de darle "permisos de administrador" para acceder a la red sin que la *Sirena* lo expulse.
                
                Primero lo usan para hacer un barrido de topos en la base, y luego Lucas entra en la "red". La *Sirena* se le aparece e intenta convencerlo, mientras las voces de de Elizabeth, Noemí, etc intentan convencerlo de liberar la señal. Lucas va "superando pruebas" como representación de las defensas de la *Sirena*.
