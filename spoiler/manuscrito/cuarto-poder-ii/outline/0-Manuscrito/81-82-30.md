...
notes:          # Ir moviendo de capítulo en capítulo
                ...
                **Repasar las notas siguientes hasta dejarlas bien definidas y sin *agujeros de guión. Por cada una ver cómo especificarla en la historia**
                ...
                Al inhabilitarse el *Mástil*, la propagación descontrolada de la *Sirena* amenaza seriamente el control de RIO, que entonces comienza a  volver violentos a grandes sectores de la población de manera controlada (por lo que no afecta a Lucas. RIO puede permitirse exponerse porque pretende borrar la memoria de los últimos días a gran escala (Gran reinicio) como suele hacer en las *Burbujas*.
                
                ## Emboscada final
                
                RIO quiere llevar a Lucas y la Resistencia para llevarlos a un centro de lanzamiento de RIO, donde planean lanzar un *Mástil* geoestacionario con la señal que matará a la *Sirena* en África como primer paso de la "liberación humana". No obstante, la base está llena de topos de la *Sirena* que planean sabotear el lanzamiento controlado por ellos. A Lucas lo quieren para **(X)**, para crear/probar una versión mejorada del mini Mástil, al tiempo que le tiende una emboscada a gran parte de la *resistencia*, diezmándolos y haciéndose con gente importante para ellos como Jonás (plan maestro).
