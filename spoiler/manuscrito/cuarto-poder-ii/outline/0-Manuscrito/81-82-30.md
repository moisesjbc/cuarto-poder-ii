...
notes:          # Ir moviendo de capítulo en capítulo
                ...
                **¿Para qué necesita a Lucas (2)?**
                ...
                a) Mero detector de trampas
                b) Lucas desactivó el Mástil bloqueara el acceso con una clave enorme / serie de comandos que recuerda por su supermemoria.
                ---> ¿Por qué RIO no lo tortura y ya? ¿Piensan que la *Sirena* podría matarlo para evitarlo?
                c) La *Sirena* controla la base pero los científicos se suicidaron / fueron ejecutados por RIO para que la *Sirena* no pudiera asimilarlos y destruir el satélite. RIO quiere meter a Lucas como un caballo de troya para activar el Mástil en el momento justo y que este pueda cargar la señal que destruiría a la Sirena. Lucas lo que hace al final es destruir el Mástil?
                d) La *Sirena* controla la base y demás como en la opción (c). Sí que se llegó a lanzar el *Mástil* de repuesto y se activó, pero la *Sirena* ha creado *Burbujas* en la base y demás sitios en el mundo. Lucas puede desactivar las *Burbujas* porque...
                e) RIO quiere engañar a Lucas y a la Resistencia para llevarlos a un centro de investigación controlado por ellos. A Lucas lo quieren por su hipersensibilidad a la *Sirena*, para crear/probar una versión mejorada del mini Mástil, al tiempo que le tiende una emboscada a gran parte de la *resistencia* (se hacen con Ana, Jonás, etc).
