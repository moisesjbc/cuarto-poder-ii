# Este será el último libro de Cuarto Poder
...
- Cambiar título (actualmente: "Estallido").
...
- Mencionar en siguientes capítulos que RIO no entiende por qué ha perdido el control sobre la *Burbuja* (desconocen el *Canto de Sirena*)
- Pensar para qué necesitan el *Canto de Sirena*
...
- Presentación de Ajani, Kasim y la francotiradora.
    - Lugar de nacimiento de Ajani: ¿lo dejo como Nigeria o pongo otro sitio?.
        - Informarme del sitio en cualquier caso.
    - Los nombres de Ajani y Karim dicen que son “africanos”, pero ¿qué lengua exacta? 
    - Nombre para la francotiradora que lo acompaña.
    - Es Juan (el héroe) – COMPROBAR NOMBRE EN ELLIBROVIRTUAL el que lo salva y el que lo avisa. 
        - Ajani y Kasim (no llegué a decir los nombres “españoles”).
- Aitor
- Paradero de Noemí
- Paradero de Ana.
- Se revela que en el ataque "fallido" de la Resistencia al complejo de RIO, Jonás le dio algo a Cooper (¿credenciales?)
- Mención a por qué las nanomáquinas no se usan en producción aún (tanto como controladoras de la voluntad como creadoras de superficies).
- Aclarar por qué en el primer libro soltaron a Lucas en una *Burbuja* "a tomar por culo" sin más.
- Aclarar por qué en el primer libro Ajani ha orquestado un ataque a La Cadena supuestamente fallido y ha desaparecido.
- Aclarar qué ocurre con la cinta donde aparece Lucas y la liberación de la ciudad burbuja.
- Aclarar motivación de RIO para la farsa de Inglaterra.
- En el capítulo 17 de la primera parte se menciona que a Arturo se le inyectaba algo cada día media hora antes de las sesiones de hacerlo caminar sobre las nanomáquinas. Especificar qué más adelante en el libro. → ¿Intento de “sensibilizarlo” a las nanomáquinas?
- Destino de El Venelozano, Lucía, Noemí.
- **¿Por qué el "agente de negro" salva a Paco e el capítulo 4 de la primera parte?**
    - **Si es cierto que es un personaje importante de RIO... ¿amnesia inducida?**
- ¿Quiénes resultan ser María y Noemí?
- Motivación falsa de Jonás.
- Aclarar que las notas del ilófono (tres notas graves, cortas, seguidas de una larga y aguda) no es nada importante / es algo que predispone a la señal del *Canto de Sirena*.
- Aclarar por qué los ingleses atacan La Cadena sin avisar a los rebeldes.
...
- *Arcos abiertos en parte anterior*
- Verdadera motivación de Jonás.
...
- Continuación del plan de Elizabeth.
- Revelación de la motivación real / origen de Ana y Elizabeth.
...
- Verdadera motivación de las nanomáquinas como controladoras de la voluntad:
    - Resistencia a *Canto de Sirena*
- Verdadera motivación de las *Burbujas*.
    - a) Las *Burbujas* son pruebas para descubrir ciudadanos prometedores para Atlántida
    - b) Las condiciones ambientales de Atlántida han dejado estéril a gran parte / toda la población de Atlántida. Por esta razón se ven "obligados" a extraer gente de La Tierra.
    - c) Aclarar por qué algunos sujetos son conscientes de lo que pasa y no son "zombies"
- **Contar origen real de Atlántida y RIO. REFINAR [Origen de Atlántida](origen_a.md) y seleccionar origen.**
...
- Aclarar qué estuvo haciendo Ajani para no poder participar en el asalto a La Cadena.
- Aclarar motivación de Atlántida para la farsa de Inglaterra.
- **¿FINAL DEL LIBRO?**
    - a) Lucas es obligado a elegir un bando en la guerra interna de Atlántida por abrir las puertas o seguir limitando el acceso.
        - Conversaciones de Lucas con Ajani y Cía como partidarios de limitar el acceso a Atlántida y con Elizabeth (¿en prisión?) como partidaria de abrir las fronteras.
 
# Frases / fragmentos para usar
